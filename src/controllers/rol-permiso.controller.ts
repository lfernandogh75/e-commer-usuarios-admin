...
export class RolPermisoController {
  ...
  async find(
    ...
    return this.rolRepository.tiene_permiso(id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.tiene_permiso(id).create(permiso);
  }
  ...
  async patch(
    ...
    return this.rolRepository.tiene_permiso(id).patch(permiso, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.tiene_permiso(id).delete(where);
  }
}
